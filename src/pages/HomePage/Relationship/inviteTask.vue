<template>
  <div style="height:100%">
    ...
    <!-- 导航栏 -->
    <x-header slot="header" style="width:100%;position:absolute;left:0;top:0;z-index:100;" :left-options="{showBack: true,backText: ''}">邀约任务</x-header>
    <!-- tab 栏 -->
...
export default {
  ...
  methods: {
    ...
    goRoute({ relaId }) {
      this.$router.push({ name: "invitelist", query: { relaId } });
    }
  },
  created() {
    // this.getData()
